...
<LinkButton
  ...
  target="_blank"
>
  Basic Auth Demo Repo - Complete Reference
</LinkButton>

### ⏭ Next: Beyond Basic Authentication

Now that we have a solid foundation, let's explore some advanced authentication concepts and best practices.
We won't be implementing these in the portfolio app, but they are important to know for future reference.
