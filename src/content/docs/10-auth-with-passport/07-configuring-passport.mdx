...
<NoteBox>
  **Professor Solo:** You might be wondering why `server.js` can call
  ...
  configures it, and then directly exports it utilizing `module.exports =
  passport;`, we are passing back the genuine, fully authentic native Passport
