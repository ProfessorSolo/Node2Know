...
### ⏭ Next: Translating References

Now your database captures the relationship. But what happens when we read that project back from the database? How do we hydrate the actual category name?
