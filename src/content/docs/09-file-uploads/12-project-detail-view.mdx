...
### ⏭ Next: Uploads Wrap-Up

We've successfully built a relational database mapper and navigated the complexities of processing binary document streams, splitting out metadata from the binary data, and rendering it all in the front end!
Let's take a look back at what we've accomplished in this section.
