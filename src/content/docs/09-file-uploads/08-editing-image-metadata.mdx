...
Our backend is successfully capturing the image file, tossing it onto the local disk, and saving the subdocument metadata cleanly inside our MongoDB array.
...
<NoteBox title="Professor Solo">
  ...
  ever be selected as the featured image at a time!
</NoteBox>
