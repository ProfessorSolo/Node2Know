...
<img
  src="/assets/lessons/09-file-uploads/project-list-view.png"
  alt="Neo-Retro isometric diagram showing an EJS template iterating over Project Documents to find the featuredImage subdocument and construct a dynamic URL path."
/>
