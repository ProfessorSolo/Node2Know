...
We want to intercept inbound file traffic explicitly, test its type to ensure it is an image, and deposit it into our `/public/uploads` directory.

Create the `middleware/upload.js` file:
