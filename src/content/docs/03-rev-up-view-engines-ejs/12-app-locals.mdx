...
app.locals.adminEmail = "help@node2know.com";
...
```html
<footer>
  <!-- 'appTitle' and 'copyrightYear' come from app.locals -->
  <p>&copy; <%= copyrightYear %> <%= appTitle %></p>
  <p>Contact: <a href="mailto:<%= adminEmail %>"><%= adminEmail %></a></p>
</footer>
```

<div class="next-step">
  <h3>⏭ The Garage Lab</h3>
