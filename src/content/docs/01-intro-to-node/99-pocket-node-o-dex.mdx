...
> [!TIP]
> **Solo's Pro-Tip:** "Put that 'Live Server' EXTENSION away for now and for node.
> We use <code>node --watch app.js</code> on this site. It restarts the _server_ for us when we save files, but...
> we will still have to **manually refresh the browser** for front-end changes.
...
<LinkButton
  href="/assets/resources/slide-decks/IntroToNode/NODE_JS_CORE_PROTOCOL.pdf"
  target="_blank"
  variant="secondary"
>
