...
<Aside type="note">
  ...
  **absolute path** to the directory where the current script is living.
</Aside>
...
<LinkButton
  href="https://github.com/ProfessorSolo/Node2Know-FileSystemFS"
  variant="primary"
  icon="external"
  target="_blank"
>
  File System (fs) Demo Repo
</LinkButton>
...
We've covered a lot of ground. We've learned the basics.
