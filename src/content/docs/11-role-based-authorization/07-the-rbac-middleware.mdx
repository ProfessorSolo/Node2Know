...
<img
  src="/assets/lessons/11-role-based-authorization/rbac_two_layer_security.png"
  alt="Neo-Retro isometric conceptual diagram illustrating a Two-Layer security architecture with Authentication and Authorization shields"
/>

_Fig 1: Layer 1 Authentication (Passport) vs. Layer 2 Authorization (RBAC)_
