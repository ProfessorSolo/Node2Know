...
With our access rules clearly defined, we must mutate our existing MongoDB schema to physically track the assignment of these roles against our active User records.
